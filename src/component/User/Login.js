                ...
                { page === 'login' ?
                 <Grid item xs={12} sm={6} >
                    ...
                    <Typography sx={{justifyContent:'center', display: 'flex' }}>    
                        <StyledInput id="outlined-basic" label="Email" variant="outlined"  value={username} required
                    ...
                    <Typography  mt={2}  sx={{justifyContent:'center', display: 'flex' }}>    
                        ...
                        <StyledInput id="outlined-basic-password" label="password" variant="outlined" type={showPassword? 'text': 'password'} 
                            InputProps={{
                                endAdornment: (
                    ...
                    <Typography className='button-container' mt={2} sx={{display:'flex', justifyContent: 'space-evenly'}}>
                       <a href="#" onClick={redirectForgot}  style={{position:'relative', right: '8px'}} >{config.loginForgotPassword}</a> 
                        <PrimaryButton variant='contained' className='buttonPrimarylogin'
                           onClick={redirectAuthenticator}>{config.loginButton}</PrimaryButton>
                    </Typography>
                    <div className='no-account' onClick={redirectRegister}> {config.loginAccount} <a href="#" >{config.loginContactUS}</a></div> 
                    <Footer style='75px'/>
                </Grid> : page ==='signup' ? 
                   <Registration  setPage={setPage}/> : page ==='forgot' ? <ForgotPassword setPage={setPage} page={page}/> : page==='link'?
